...
const PLAYERS: Player[] = [
  { rank: 1, name: "Alexander", points: 111, change: 0, exact: 7 },
  { rank: 2, name: "Einar Eikeland", points: 109, change: 1, exact: 11 },
  { rank: 3, name: "tROnd d", points: 109, change: -1, exact: 9 },
  { rank: 4, name: "Christopher", points: 106, change: 0, exact: 10 },
  { rank: 5, name: "Mats Knudsen", points: 105, change: 5, exact: 11 },
  { rank: 6, name: "Joacim T", points: 105, change: 3, exact: 5 },
  { rank: 7, name: "Peter Nygård", points: 104, change: -3, exact: 10 },
  { rank: 8, name: "Marit H", points: 103, change: 8, exact: 7 },
  { rank: 8, name: "FotMob Fan #46629", points: 103, change: -1, exact: 7 },
  { rank: 8, name: "Hilde Berg", points: 103, change: -1, exact: 7 },
  { rank: 11, name: "Kjersti Lønningdal", points: 103, change: 3, exact: 5 },
  { rank: 12, name: "Benjamin", points: 102, change: 3, exact: 8 },
  { rank: 13, name: "Andreas Veheim", points: 102, change: -7, exact: 6 },
  { rank: 14, name: "Andreas Enehaug", points: 101, change: -1, exact: 9 },
  { rank: 15, name: "Irene", points: 100, change: -3, exact: 10 },
  { rank: 16, name: "Megan", points: 99, change: 3, exact: 9 },
  { rank: 17, name: "Frank Erik", points: 99, change: 1, exact: 7 },
  { rank: 17, name: "Oddgeir", points: 99, change: 6, exact: 7 },
  { rank: 17, name: "Bjørn Inge", points: 99, change: -6, exact: 7 },
  { rank: 20, name: "Kristoffer Lie", points: 98, change: -3, exact: 8 },
  { rank: 21, name: "Siv Merete Fjeldseth", points: 98, change: -1, exact: 6 },
  { rank: 22, name: "Lars Kvalbein", points: 97, change: -1, exact: 9 },
  { rank: 23, name: "Soccer-Hauken", points: 96, change: 1, exact: 4 },
  { rank: 24, name: "Thomas Veheim", points: 95, change: 3, exact: 9 },
  { rank: 25, name: "Darth Vader", points: 94, change: -4, exact: 8 },
  { rank: 26, name: "TroND M", points: 94, change: 2, exact: 6 },
  { rank: 27, name: "Fredrik Fahlstrøm", points: 94, change: -2, exact: 4 },
  { rank: 28, name: "May Linn Berg", points: 93, change: -2, exact: 7 },
  { rank: 29, name: "Kenneth Balsnes", points: 91, change: 2, exact: 9 },
  { rank: 30, name: "Øyvind", points: 91, change: -1, exact: 5 },
  { rank: 31, name: "Jørgen Ramsdal", points: 90, change: -1, exact: 6 },
  { rank: 32, name: "Lisbeth", points: 82, change: 0, exact: 6 },
  { rank: 33, name: "Jonathan", points: 81, change: 0, exact: 5 },
  { rank: 34, name: "Tore Nesheim", points: 78, change: 1, exact: 4 },
  { rank: 35, name: "Rune Rafteseth", points: 76, change: -1, exact: 8 },
  { rank: 36, name: "Fahlstrom", points: 71, change: 0, exact: 5 },
  { rank: 37, name: "Torkild Hjelmtveit", points: 68, change: 0, exact: 2 },
  { rank: 38, name: "Thomas Karlsnes", points: 64, change: 0, exact: 4 },
  { rank: 39, name: "William", points: 64, change: 0, exact: 2 },
];
