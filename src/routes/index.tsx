...
const PLAYERS: Player[] = [
  { rank: 1, name: "tROnd d", points: 85, change: 5 },
  { rank: 2, name: "Benjamin", points: 85, change: -1 },
  { rank: 3, name: "Peter Nygård", points: 84, change: -1 },
  { rank: 4, name: "Bjørn Inge", points: 83, change: 7 },
  { rank: 5, name: "Christopher", points: 82, change: -1 },
  { rank: 6, name: "Hilde Berg", points: 82, change: -1 },
  { rank: 7, name: "Mats Knudsen", points: 81, change: -5 },
  { rank: 8, name: "Lars Kvalbein", points: 81, change: -1 },
  { rank: 8, name: "Einar Eikeland", points: 81, change: 0 },
  { rank: 10, name: "Alexander", points: 79, change: -1 },
  { rank: 10, name: "Geir Myhre", points: 79, change: 4 },
  { rank: 12, name: "Kristoffer Lie", points: 78, change: 3 },
  { rank: 13, name: "Darth Vader", points: 77, change: 5 },
  { rank: 14, name: "Frank Erik", points: 77, change: -2 },
  { rank: 14, name: "Siv Merete Fjeldseth", points: 77, change: 5 },
  { rank: 14, name: "Andreas Veheim", points: 77, change: -2 },
  { rank: 14, name: "Oddgeir", points: 77, change: -5 },
  { rank: 18, name: "Joacim T", points: 77, change: -1 },
  { rank: 19, name: "Megan", points: 75, change: 1 },
  { rank: 20, name: "Andreas Enehaug", points: 75, change: -4 },
  { rank: 21, name: "Irene", points: 74, change: 0 },
  { rank: 22, name: "Marit H", points: 74, change: 0 },
  { rank: 23, name: "Soccer-Hauken", points: 73, change: 3 },
  { rank: 23, name: "Kjersti Lønningdal", points: 73, change: -1 },
  { rank: 25, name: "Thomas Veheim", points: 71, change: 4 },
  { rank: 25, name: "May Linn Berg", points: 71, change: 3 },
  { rank: 27, name: "Jørgen Ramsdal", points: 71, change: -3 },
  { rank: 28, name: "Fredrik Fahlstrøm", points: 71, change: -2 },
  { rank: 29, name: "Fahlstrom", points: 69, change: -5 },
  { rank: 30, name: "Lisbeth", points: 68, change: 1 },
  { rank: 31, name: "TroND M", points: 67, change: 2 },
  { rank: 31, name: "Øyvind", points: 67, change: -1 },
  { rank: 33, name: "Kenneth Balsnes", points: 63, change: 1 },
  { rank: 34, name: "Torkild Hjelmtveit", points: 62, change: -2 },
  { rank: 35, name: "Rune Rafteseth", points: 61, change: 0 },
  { rank: 36, name: "Jonathan", points: 60, change: 0 },
  { rank: 37, name: "Tore Nesheim", points: 60, change: 0 },
  { rank: 38, name: "Thomas Karlsnes", points: 47, change: 1 },
  { rank: 39, name: "William", points: 46, change: -1 },
];
