...
const PLAYERS: Player[] = [
  { rank: 1, name: "Alexander", points: 107, change: 0, exact: 7 },
  { rank: 2, name: "tROnd d", points: 105, change: 1, exact: 9 },
  { rank: 3, name: "Einar Eikeland", points: 104, change: -1, exact: 10 },
  { rank: 4, name: "Peter Nygård", points: 102, change: 1, exact: 10 },
  { rank: 4, name: "Christopher", points: 102, change: 1, exact: 10 },
  { rank: 6, name: "Andreas Veheim", points: 102, change: 1, exact: 6 },
  { rank: 7, name: "Hilde Berg", points: 101, change: 3, exact: 7 },
  { rank: 7, name: "Geir Myhre", points: 101, change: -3, exact: 7 },
  { rank: 9, name: "Joacim T", points: 100, change: 2, exact: 4 },
  { rank: 10, name: "Mats Knudsen", points: 99, change: -2, exact: 9 },
  { rank: 11, name: "Bjørn Inge", points: 99, change: -2, exact: 7 },
  { rank: 12, name: "Irene", points: 98, change: 3, exact: 10 },
  { rank: 13, name: "Andreas Enehaug", points: 98, change: 0, exact: 8 },
  { rank: 14, name: "Kjersti Lønningdal", points: 98, change: 0, exact: 4 },
  { rank: 15, name: "Benjamin", points: 97, change: -3, exact: 7 },
  { rank: 16, name: "Marit H", points: 97, change: 1, exact: 5 },
  { rank: 17, name: "Kristoffer Lie", points: 96, change: 1, exact: 8 },
  { rank: 18, name: "Frank Erik", points: 96, change: 3, exact: 6 },
  { rank: 19, name: "Megan", points: 95, change: -4, exact: 9 },
  { rank: 20, name: "Siv Merete Fjeldseth", points: 95, change: 2, exact: 5 },
  { rank: 21, name: "Darth Vader", points: 94, change: -3, exact: 8 },
  { rank: 21, name: "Lars Kvalbein", points: 94, change: -3, exact: 8 },
  { rank: 23, name: "Oddgeir", points: 94, change: 0, exact: 6 },
  { rank: 24, name: "Soccer-Hauken", points: 94, change: 0, exact: 4 },
  { rank: 25, name: "Fredrik Fahlstrøm", points: 92, change: 1, exact: 4 },
  { rank: 26, name: "May Linn Berg", points: 91, change: 1, exact: 7 },
  { rank: 27, name: "Thomas Veheim", points: 90, change: -2, exact: 8 },
  { rank: 28, name: "TroND M", points: 90, change: 0, exact: 6 },
  { rank: 29, name: "Øyvind", points: 89, change: 0, exact: 5 },
  { rank: 30, name: "Jørgen Ramsdal", points: 87, change: 0, exact: 5 },
  { rank: 31, name: "Kenneth Balsnes", points: 86, change: 0, exact: 8 },
  { rank: 32, name: "Lisbeth", points: 82, change: 0, exact: 6 },
  { rank: 33, name: "Jonathan", points: 79, change: 0, exact: 5 },
  { rank: 34, name: "Rune Rafteseth", points: 76, change: 0, exact: 8 },
  { rank: 35, name: "Tore Nesheim", points: 75, change: 0, exact: 3 },
  ...
  { rank: 39, name: "William", points: 62, change: 0, exact: 2 },
];
