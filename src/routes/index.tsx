...
const PLAYERS: Player[] = [
  { rank: 1, name: "Mats Knudsen", points: 139, change: 0, exact: 15 },
  { rank: 2, name: "Kjersti Lønningdal", points: 139, change: 0, exact: 9 },
  { rank: 3, name: "Andreas Enehaug", points: 138, change: 0, exact: 16 },
  { rank: 4, name: "Einar Eikeland", points: 138, change: 0, exact: 14 },
  { rank: 4, name: "Irene", points: 138, change: 0, exact: 14 },
  { rank: 4, name: "Frank Erik", points: 138, change: 6, exact: 14 },
  { rank: 7, name: "Oddgeir", points: 138, change: -1, exact: 12 },
  { rank: 7, name: "Marit H", points: 138, change: -1, exact: 12 },
  { rank: 9, name: "Alexander", points: 138, change: 0, exact: 8 },
  { rank: 10, name: "tROnd d", points: 136, change: -4, exact: 12 },
  { rank: 11, name: "Joacim T", points: 136, change: 0, exact: 8 },
  { rank: 12, name: "Benjamin", points: 135, change: 0, exact: 13 },
  { rank: 13, name: "Christopher", points: 134, change: 0, exact: 12 },
  { rank: 14, name: "Peter Nygård", points: 131, change: 0, exact: 13 },
  { rank: 15, name: "TroND M", points: 131, change: 2, exact: 9 },
  { rank: 16, name: "Kristoffer Lie", points: 130, change: 2, exact: 10 },
  { rank: 16, name: "Geir", points: 130, change: -1, exact: 10 },
  { rank: 18, name: "Andreas Veheim", points: 130, change: -2, exact: 8 },
  { rank: 19, name: "Fredrik Fahlstrøm", points: 128, change: 0, exact: 6 },
  { rank: 20, name: "Hilde Berg", points: 127, change: 0, exact: 9 },
  { rank: 21, name: "Soccer-Hauken", points: 127, change: 0, exact: 7 },
  { rank: 22, name: "May Linn Berg", points: 126, change: 1, exact: 10 },
  { rank: 23, name: "Megan", points: 123, change: -1, exact: 11 },
  { rank: 24, name: "Øyvind", points: 123, change: 1, exact: 9 },
  { rank: 25, name: "Thomas Veheim", points: 122, change: -1, exact: 12 },
  { rank: 26, name: "Siv Merete Fjeldseth", points: 122, change: -1, exact: 8 },
  { rank: 27, name: "Lars Kvalbein", points: 118, change: 0, exact: 10 },
  { rank: 28, name: "Jonathan", points: 116, change: 0, exact: 6 },
  { rank: 29, name: "Kenneth Balsnes", points: 114, change: 0, exact: 12 },
  { rank: 30, name: "Jørgen Ramsdal", points: 113, change: 0, exact: 9 },
  { rank: 31, name: "Lisbeth", points: 113, change: 0, exact: 7 },
  { rank: 32, name: "Darth Vader", points: 112, change: 0, exact: 10 },
  { rank: 33, name: "Tore Nesheim", points: 104, change: 0, exact: 6 },
  { rank: 34, name: "Bjørn Inge", points: 99, change: 0, exact: 7 },
  { rank: 35, name: "William", points: 92, change: 0, exact: 4 },
