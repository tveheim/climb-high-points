...
const PLAYERS: Player[] = [
  { rank: 1, name: "Kjersti Lønningdal", points: 142, change: 1, exact: 10 },
  { rank: 2, name: "Mats Knudsen", points: 141, change: -1, exact: 15 },
  { rank: 3, name: "Marit H", points: 141, change: 4, exact: 13 },
  { rank: 4, name: "Andreas Enehaug", points: 140, change: -1, exact: 16 },
  { rank: 5, name: "Einar Eikeland", points: 140, change: -1, exact: 14 },
  { rank: 5, name: "Frank Erik", points: 140, change: -1, exact: 14 },
  { rank: 7, name: "Oddgeir", points: 140, change: 0, exact: 12 },
  { rank: 8, name: "Alexander", points: 140, change: 1, exact: 8 },
  { rank: 9, name: "Benjamin", points: 138, change: 3, exact: 14 },
  { rank: 9, name: "Irene", points: 138, change: -5, exact: 14 },
  { rank: 11, name: "tROnd d", points: 138, change: -1, exact: 12 },
  { rank: 12, name: "Joacim T", points: 138, change: -1, exact: 8 },
  { rank: 13, name: "Christopher", points: 137, change: 0, exact: 13 },
  { rank: 14, name: "Peter Nygård", points: 133, change: 0, exact: 13 },
  { rank: 15, name: "TroND M", points: 133, change: 0, exact: 9 },
  { rank: 16, name: "Kristoffer Lie", points: 132, change: 0, exact: 10 },
  { rank: 16, name: "Geir", points: 132, change: 0, exact: 10 },
  { rank: 18, name: "Andreas Veheim", points: 132, change: 0, exact: 8 },
  { rank: 19, name: "Fredrik Fahlstrøm", points: 130, change: 0, exact: 6 },
  { rank: 20, name: "Soccer-Hauken", points: 129, change: 1, exact: 7 },
  { rank: 21, name: "May Linn Berg", points: 128, change: 1, exact: 10 },
  { rank: 22, name: "Hilde Berg", points: 127, change: -2, exact: 9 },
  { rank: 23, name: "Øyvind", points: 125, change: 1, exact: 9 },
  { rank: 23, name: "Siv Merete Fjeldseth", points: 125, change: 3, exact: 9 },
  { rank: 25, name: "Thomas Veheim", points: 124, change: 0, exact: 12 },
  { rank: 26, name: "Megan", points: 123, change: -3, exact: 11 },
  { rank: 27, name: "Lars Kvalbein", points: 120, change: 0, exact: 10 },
  { rank: 28, name: "Jonathan", points: 118, change: 0, exact: 6 },
  { rank: 29, name: "Jørgen Ramsdal", points: 115, change: 1, exact: 9 },
  { rank: 30, name: "Lisbeth", points: 115, change: 1, exact: 7 },
  { rank: 31, name: "Kenneth Balsnes", points: 114, change: -2, exact: 12 },
