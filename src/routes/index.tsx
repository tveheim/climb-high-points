...
const PLAYERS: Player[] = [
  ...
  { rank: 2, name: "Andreas Enehaug", points: 143, change: 5, exact: 17 },
  { rank: 3, name: "Kjersti Lønningdal", points: 142, change: -1, exact: 10 },
  { rank: 4, name: "Alexander", points: 142, change: -1, exact: 8 },
  { rank: 5, name: "Mats Knudsen", points: 141, change: -1, exact: 15 },
  { rank: 6, name: "Marit H", points: 141, change: -1, exact: 13 },
  { rank: 7, name: "Joacim T", points: 141, change: -1, exact: 9 },
  { rank: 8, name: "Irene", points: 140, change: 3, exact: 14 },
  { rank: 8, name: "Frank Erik", points: 140, change: 0, exact: 14 },
  { rank: 8, name: "Einar Eikeland", points: 140, change: 0, exact: 14 },
  { rank: 11, name: "Christopher", points: 139, change: -1, exact: 13 },
  { rank: 12, name: "Benjamin", points: 138, change: -1, exact: 14 },
  { rank: 13, name: "tROnd d", points: 138, change: 0, exact: 12 },
  { rank: 14, name: "Kristoffer Lie", points: 137, change: 0, exact: 11 },
  { rank: 15, name: "Geir", points: 134, change: -1, exact: 10 },
  { rank: 16, name: "Peter Nygård", points: 133, change: 0, exact: 13 },
  { rank: 17, name: "TroND M", points: 133, change: 0, exact: 9 },
  { rank: 18, name: "Fredrik Fahlstrøm", points: 133, change: 1, exact: 7 },
  { rank: 19, name: "Andreas Veheim", points: 132, change: -1, exact: 8 },
  { rank: 20, name: "May Linn Berg", points: 131, change: 1, exact: 11 },
  { rank: 21, name: "Soccer-Hauken", points: 131, change: -1, exact: 7 },
  { rank: 22, name: "Hilde Berg", points: 127, change: 0, exact: 9 },
  { rank: 23, name: "Megan", points: 126, change: 3, exact: 12 },
  { rank: 24, name: "Siv Merete Fjeldseth", points: 125, change: -1, exact: 9 },
  { rank: 24, name: "Øyvind", points: 125, change: -1, exact: 9 },
  { rank: 26, name: "Thomas Veheim", points: 124, change: -1, exact: 12 },
  ...
  { rank: 30, name: "Lisbeth", points: 118, change: 1, exact: 8 },
  { rank: 31, name: "Kenneth Balsnes", points: 116, change: -1, exact: 12 },
