...
const PLAYERS: Player[] = [
  { rank: 1, name: "Alexander", points: 126, change: 2, exact: 8 },
  { rank: 2, name: "Mats Knudsen", points: 125, change: 2, exact: 15 },
  { rank: 3, name: "Einar Eikeland", points: 125, change: -2, exact: 13 },
  { rank: 4, name: "tROnd d", points: 125, change: -2, exact: 11 },
  { rank: 5, name: "Andreas Enehaug", points: 123, change: 0, exact: 15 },
  { rank: 6, name: "Kjersti Lønningdal", points: 123, change: 5, exact: 9 },
  { rank: 7, name: "Marit H", points: 121, change: 3, exact: 11 },
  { rank: 8, name: "Geir", points: 120, change: -2, exact: 10 },
  { rank: 9, name: "Christopher", points: 119, change: -1, exact: 11 },
  { rank: 9, name: "Benjamin", points: 119, change: -1, exact: 11 },
  { rank: 9, name: "Frank Erik", points: 119, change: 6, exact: 11 },
  { rank: 9, name: "Irene", points: 119, change: 3, exact: 11 },
  { rank: 13, name: "Joacim T", points: 119, change: -6, exact: 7 },
  { rank: 14, name: "Megan", points: 117, change: -1, exact: 11 },
  { rank: 15, name: "Oddgeir", points: 117, change: 1, exact: 9 },
  { rank: 16, name: "Peter Nygård", points: 114, change: -3, exact: 10 },
  { rank: 17, name: "Kristoffer Lie", points: 114, change: 2, exact: 8 },
  { rank: 17, name: "Hilde Berg", points: 114, change: -1, exact: 8 },
  { rank: 19, name: "Andreas Veheim", points: 113, change: -1, exact: 7 },
  { rank: 20, name: "Fredrik Fahlstrøm", points: 112, change: 1, exact: 6 },
  { rank: 21, name: "May Linn Berg", points: 111, change: 2, exact: 9 },
  { rank: 22, name: "Soccer-Hauken", points: 111, change: 2, exact: 5 },
  { rank: 23, name: "Thomas Veheim", points: 109, change: -1, exact: 11 },
  { rank: 24, name: "TroND M", points: 109, change: 2, exact: 7 },
  { rank: 24, name: "Siv Merete Fjeldseth", points: 109, change: -4, exact: 7 },
  { rank: 26, name: "Øyvind", points: 106, change: 1, exact: 6 },
  { rank: 27, name: "Lars Kvalbein", points: 105, change: -2, exact: 9 },
  { rank: 28, name: "Darth Vader", points: 103, change: 1, exact: 9 },
  { rank: 29, name: "Kenneth Balsnes", points: 101, change: 2, exact: 11 },
  { rank: 30, name: "Jørgen Ramsdal", points: 101, change: -1, exact: 9 },
  { rank: 31, name: "Bjørn Inge", points: 99, change: -3, exact: 7 },
  { rank: 32, name: "Lisbeth", points: 97, change: 0, exact: 7 },
  { rank: 33, name: "Jonathan", points: 97, change: 0, exact: 5 },
  { rank: 34, name: "Tore Nesheim", points: 91, change: 0, exact: 5 },
  { rank: 35, name: "Torkild Hjelmtveit", points: 82, change: 0, exact: 4 },
  { rank: 36, name: "Fahlstrom", points: 79, change: 0, exact: 5 },
  { rank: 37, name: "William", points: 78, change: 1, exact: 2 },
  { rank: 38, name: "Rune Rafteseth", points: 76, change: -1, exact: 8 },
  { rank: 39, name: "Thomas Karlsnes", points: 68, change: 0, exact: 4 },
];
