...
const PLAYERS: Player[] = [
  { rank: 1, name: "Mats Knudsen", points: 135, change: 4, exact: 15 },
  { rank: 2, name: "Andreas Enehaug", points: 134, change: -1, exact: 16 },
  { rank: 3, name: "Einar Eikeland", points: 134, change: -1, exact: 14 },
  { rank: 3, name: "Irene", points: 134, change: -1, exact: 14 },
  { rank: 5, name: "Oddgeir", points: 134, change: 2, exact: 12 },
  { rank: 5, name: "tROnd d", points: 134, change: 2, exact: 12 },
  { rank: 7, name: "Alexander", points: 134, change: -3, exact: 8 },
  { rank: 8, name: "Frank Erik", points: 133, change: -2, exact: 13 },
  { rank: 9, name: "Kjersti Lønningdal", points: 133, change: 0, exact: 9 },
  { rank: 10, name: "Marit H", points: 132, change: 0, exact: 12 },
  { rank: 11, name: "Benjamin", points: 131, change: 1, exact: 13 },
  { rank: 12, name: "Christopher", points: 130, change: 1, exact: 12 },
  { rank: 13, name: "Joacim T", points: 130, change: -2, exact: 8 },
  { rank: 14, name: "Peter Nygård", points: 129, change: 0, exact: 13 },
  { rank: 15, name: "Geir", points: 128, change: 0, exact: 10 },
  { rank: 16, name: "Andreas Veheim", points: 128, change: 0, exact: 8 },
  { rank: 17, name: "Hilde Berg", points: 125, change: 0, exact: 9 },
  { rank: 17, name: "Kristoffer Lie", points: 125, change: 0, exact: 9 },
  { rank: 17, name: "TroND M", points: 125, change: 4, exact: 9 },
  { rank: 20, name: "Fredrik Fahlstrøm", points: 124, change: -1, exact: 6 },
  { rank: 21, name: "Soccer-Hauken", points: 123, change: 1, exact: 7 },
  { rank: 22, name: "Megan", points: 121, change: -2, exact: 11 },
  { rank: 23, name: "May Linn Berg", points: 121, change: 0, exact: 9 },
  { rank: 24, name: "Thomas Veheim", points: 118, change: 2, exact: 12 },
  { rank: 25, name: "Siv Merete Fjeldseth", points: 118, change: -1, exact: 8 },
  { rank: 25, name: "Øyvind", points: 118, change: 2, exact: 8 },
  { rank: 27, name: "Lars Kvalbein", points: 116, change: -2, exact: 10 },
  { rank: 28, name: "Kenneth Balsnes", points: 110, change: 0, exact: 12 },
  { rank: 29, name: "Darth Vader", points: 110, change: 0, exact: 10 },
  { rank: 30, name: "Jonathan", points: 110, change: 0, exact: 6 },
  { rank: 31, name: "Jørgen Ramsdal", points: 109, change: 0, exact: 9 },
  { rank: 32, name: "Lisbeth", points: 109, change: 0, exact: 7 },
  { rank: 33, name: "Tore Nesheim", points: 102, change: 0, exact: 6 },
  { rank: 34, name: "Bjørn Inge", points: 99, change: 0, exact: 7 },
  { rank: 35, name: "William", points: 87, change: 0, exact: 3 },
