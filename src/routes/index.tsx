...
const PLAYERS: Player[] = [
  { rank: 1, name: "Einar Eikeland", points: 117, change: 1, exact: 13 },
  { rank: 2, name: "Alexander", points: 116, change: -1, exact: 8 },
  { rank: 3, name: "Mats Knudsen", points: 113, change: 2, exact: 13 },
  { rank: 4, name: "tROnd d", points: 113, change: -1, exact: 9 },
  { rank: 5, name: "Joacim T", points: 112, change: 1, exact: 6 },
  { rank: 6, name: "Christopher", points: 111, change: -2, exact: 11 },
  { rank: 7, name: "Andreas Enehaug", points: 110, change: 7, exact: 12 },
  { rank: 8, name: "Geir", points: 109, change: 0, exact: 9 },
  { rank: 9, name: "Kjersti Lønningdal", points: 109, change: 2, exact: 7 },
  { rank: 10, name: "Benjamin", points: 108, change: 2, exact: 10 },
  { rank: 10, name: "Peter Nygård", points: 108, change: -3, exact: 10 },
  { rank: 12, name: "Marit H", points: 108, change: -4, exact: 8 },
  { rank: 13, name: "Irene", points: 107, change: 2, exact: 11 },
  { rank: 14, name: "Frank Erik", points: 107, change: 3, exact: 9 },
  { rank: 15, name: "Megan", points: 106, change: 1, exact: 10 },
  { rank: 16, name: "Hilde Berg", points: 106, change: -8, exact: 8 },
  { rank: 17, name: "Andreas Veheim", points: 106, change: -4, exact: 6 },
  { rank: 18, name: "Oddgeir", points: 105, change: -1, exact: 7 },
  { rank: 19, name: "Kristoffer Lie", points: 102, change: 1, exact: 8 },
  { rank: 20, name: "Lars Kvalbein", points: 101, change: 2, exact: 9 },
  { rank: 21, name: "Fredrik Fahlstrøm", points: 101, change: 6, exact: 5 },
  { rank: 21, name: "Soccer-Hauken", points: 101, change: 2, exact: 5 },
  { rank: 23, name: "Thomas Veheim", points: 100, change: 1, exact: 10 },
  { rank: 24, name: "May Linn Berg", points: 100, change: 4, exact: 8 },
  { rank: 25, name: "Siv Merete Fjeldseth", points: 100, change: -4, exact: 6 },
  { rank: 26, name: "TroND M", points: 99, change: 0, exact: 7 },
  { rank: 26, name: "Bjørn Inge", points: 99, change: -9, exact: 7 },
  { rank: 28, name: "Jørgen Ramsdal", points: 96, change: 3, exact: 8 },
  { rank: 29, name: "Øyvind", points: 95, change: 1, exact: 5 },
  { rank: 30, name: "Darth Vader", points: 94, change: -5, exact: 8 },
  { rank: 31, name: "Kenneth Balsnes", points: 93, change: -2, exact: 9 },
  { rank: 32, name: "Lisbeth", points: 88, change: 0, exact: 6 },
  { rank: 33, name: "Jonathan", points: 85, change: 0, exact: 5 },
  { rank: 34, name: "Tore Nesheim", points: 82, change: 0, exact: 4 },
  { rank: 35, name: "Fahlstrom", points: 77, change: 1, exact: 5 },
  { rank: 36, name: "Rune Rafteseth", points: 76, change: -1, exact: 8 },
  { rank: 37, name: "Torkild Hjelmtveit", points: 76, change: 0, exact: 4 },
  { rank: 38, name: "William", points: 70, change: 1, exact: 2 },
  { rank: 39, name: "Thomas Karlsnes", points: 64, change: -1, exact: 4 },
];
