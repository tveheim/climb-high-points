...
const PLAYERS: Player[] = [
  { rank: 1, name: "Einar Eikeland", points: 128, change: 2, exact: 14 },
  { rank: 2, name: "Alexander", points: 128, change: -1, exact: 8 },
  { rank: 3, name: "Mats Knudsen", points: 127, change: -1, exact: 15 },
  { rank: 4, name: "tROnd d", points: 127, change: 0, exact: 11 },
  { rank: 5, name: "Kjersti Lønningdal", points: 127, change: 1, exact: 9 },
  { rank: 6, name: "Andreas Enehaug", points: 125, change: -1, exact: 15 },
  { rank: 7, name: "Benjamin", points: 125, change: 2, exact: 13 },
  { rank: 7, name: "Irene", points: 125, change: 2, exact: 13 },
  { rank: 9, name: "Marit H", points: 125, change: -2, exact: 11 },
  { rank: 10, name: "Frank Erik", points: 124, change: -1, exact: 12 },
  { rank: 11, name: "Geir", points: 122, change: -3, exact: 10 },
  { rank: 11, name: "Oddgeir", points: 122, change: 4, exact: 10 },
  { rank: 13, name: "Christopher", points: 121, change: -4, exact: 11 },
  { rank: 14, name: "Joacim T", points: 121, change: -1, exact: 7 },
  { rank: 15, name: "Peter Nygård", points: 120, change: 1, exact: 12 },
  { rank: 16, name: "Kristoffer Lie", points: 119, change: 1, exact: 9 },
  { rank: 17, name: "Andreas Veheim", points: 118, change: 2, exact: 8 },
  { rank: 18, name: "Megan", points: 117, change: -4, exact: 11 },
  { rank: 19, name: "Hilde Berg", points: 116, change: -2, exact: 8 },
  { rank: 20, name: "Siv Merete Fjeldseth", points: 114, change: 4, exact: 8 },
  { rank: 20, name: "TroND M", points: 114, change: 4, exact: 8 },
  { rank: 22, name: "Fredrik Fahlstrøm", points: 114, change: -2, exact: 6 },
  { rank: 22, name: "Soccer-Hauken", points: 114, change: 0, exact: 6 },
  { rank: 24, name: "May Linn Berg", points: 113, change: -3, exact: 9 },
  { rank: 25, name: "Thomas Veheim", points: 111, change: -2, exact: 11 },
  { rank: 26, name: "Øyvind", points: 111, change: 0, exact: 7 },
  { rank: 27, name: "Lars Kvalbein", points: 110, change: 0, exact: 10 },
  { rank: 28, name: "Kenneth Balsnes", points: 106, change: 1, exact: 12 },
  { rank: 29, name: "Darth Vader", points: 103, change: -1, exact: 9 },
  { rank: 29, name: "Jørgen Ramsdal", points: 103, change: 1, exact: 9 },
  { rank: 31, name: "Jonathan", points: 102, change: 2, exact: 6 },
  { rank: 32, name: "Bjørn Inge", points: 99, change: -1, exact: 7 },
  { rank: 32, name: "Lisbeth", points: 99, change: 0, exact: 7 },
  { rank: 34, name: "Tore Nesheim", points: 94, change: 0, exact: 6 },
  { rank: 35, name: "Torkild Hjelmtveit", points: 82, change: 0, exact: 4 },
  { rank: 36, name: "William", points: 80, change: 1, exact: 2 },
  { rank: 37, name: "Fahlstrom", points: 79, change: -1, exact: 5 },
  { rank: 38, name: "Rune Rafteseth", points: 76, change: 0, exact: 8 },
  { rank: 39, name: "Thomas Karlsnes", points: 70, change: 0, exact: 4 },
];
